  ...
  return (
   <div>
     <section className="py-36 relative">
            ...
            <div className="w-full flex-col justify-center items-start gap-8 flex">
              ...
              <div className="w-full lg:justify-start justify-center items-center sm:gap-10 gap-5 inline-flex">
                <div className="flex-col justify-start items-start inline-flex">
                  <h3 className="text-gray-900 text-4xl font-bold font-manrope leading-normal">24+</h3>
      ...
      {/* <div className="px-10 max-md:px-0 mt-5 w-full h-96">
        <img src="/our-mission.jpg" className="w-full h-full" alt="" />
      </div> */}
    </section>
<Ourmission/>
   </div>
