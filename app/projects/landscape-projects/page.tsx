...
const projects = [
    {
      ...
      images: [
        "/landscape/Bahamas/Picture1.jpeg",
        "/landscape/Bahamas/Picture2.jpeg",
        "/landscape/Bahamas/Picture3.jpeg",
        "/landscape/Bahamas/Picture4.jpeg",
      ],
    }
  ];
const page = () => {
...
<div className="min-h-screen bg-gradient-to-b from-background to-muted">
      <HeaderWithTitle image={"/projects/Landscape-Projects.jpg"} title={"Landscape  Projects"} />
