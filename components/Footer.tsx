...
export default function Footer() {
  return (
    <footer
      className="bg-cover relative bg-center bg-no-repeat text-white py-12"
      ...
      <div className="relative container mx-auto px-4 z-10">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="mb-4">
              حي, JHUA8819, 8819 علي بن أبي البقاء، 3424، أبحر الشمالية، جدة
              23815{" "}
            </p>
          ...
          <div>
            ...
            <p className="mb-4"> info@delnao-ltd.com</p>
            ...
            <div className="flex space-x-4">
              ...
              <Link  href="https://www.instagram.com/delano_ltd/?utm_source=ig_web_button_share_sheet" target="_blank" className="hover:text-white">
                <Instagram size={20} />
              </Link>
              <Link href="#" className="hover:text-white">
                <Facebook size={20} />
