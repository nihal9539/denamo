...
const ServiceGrid = () => {
  return (
    <section>
      <div className="grid grid-cols-4 max-md:grid-cols-2 text-white h-[75vh] max-md:h-auto mb-10 overflow-hidden  ">
        <div className="relative h-[75vh] max-md:h-80 w-full">
          <div className="absolute z-20 space-y-3 bottom-10 max-md:left-5 max-md:bottom-5 left-10">
            ...
            <div className="border-2 flex border-white max-md:text-xs  text-sm bg-transparent  p-3 font-semibold w-32">
              VIEW PROJECT
            </div>
          </div>
